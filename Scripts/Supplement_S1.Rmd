...
author: "Nicole Grechi, Roksan Franko, Roshini Rajaraman, Jan B. Stöckl, Thomas Fröhlich, Michael J. Noonan, Marcia de A. M. M. Ferraz"
output:
  html_document:
    css: Template.css
    fig_caption: yes
...
C <- 
  ...
  scale_fill_manual(labels = c("ABS",
                    ...
                    values = c("#001219", "#8d96a3", "#005F73", "#0A9396", "#94D2BD",
                               "#E9D8A6","#EE9B00", "#CA6702",  "#9B2226",  "#6d597a", "#355070")) +
  theme_bw()+
